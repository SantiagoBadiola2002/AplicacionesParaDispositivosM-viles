...
import '../styles/verRegistroPagosProducto_styles.dart'; // Importa los estilos
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: AppStyles.appBarStyle.backgroundColor,
        titleTextStyle: AppStyles.appBarStyle.titleTextStyle,
      ),
      body: Stack(
        children: [
          // Imagen de fondo
          Positioned.fill(
            child: Image(
              image: AppStyles.backgroundImage,
              fit: BoxFit.cover,
            ),
          ),
          // Contenido
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    color: AppStyles.cardStyle.color,
                    margin: AppStyles.cardStyle.margin,
                    child: ListTile(
